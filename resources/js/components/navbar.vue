      ...
      <nav class="relative flex flex-wrap items-center justify-between md:py-4">
        ...
        <div class="hidden md:block md:ml-10 md:flex md:items-baseline md:justify-between md:bg-transparent">
          <div class="lg:absolute inset-0 flex items-center justify-center">
            <router-link to="/chores" class="text-sm font-medium text-gray-900 hover:text-gray-700">Chores</router-link>
            <router-link to="/digest" class="ml-10 text-sm font-medium text-gray-900 hover:text-gray-700">Digest</router-link>
          </div>
          <div class="ml-10 relative flex items-baseline">
            <router-link to="/login" class="text-sm font-medium text-gray-900 hover:text-gray-700">Log in</router-link>
            <router-link to="/register" class="ml-8 px-3 py-2 font-medium text-center text-sm rounded-lg bg-gray-300 text-gray-900 hover:bg-gray-400 focus:outline-none focus:bg-gray-400">Create Account</router-link>
          </div>
        </div>
      </nav>
    </div>
        ...
        <div v-show="isOpen" class="z-10 fixed inset-y-0 right-0 max-w-xs w-full bg-white transition-transform overflow-y-auto">
          <div class="relative z-10 bg-white">
            ...
            <div class="px-4 pt-4 pb-6">
              <router-link to="/"><img class="h-8 w-8" src="/img/example-logo.svg" alt=""></router-link>
              <router-link to="/chores" class="mt-4 block font-medium text-gray-900 hover:text-gray-700">Chores</router-link>
              <router-link to="/digest" class="mt-8 block text-xs font-semibold text-gray-600 uppercase tracking-wider">Digests</router-link>
              <router-link to="/digest/day" class="mt-4 block font-medium text-gray-900 hover:text-gray-700">Day</router-link>
              <router-link to="/digest/week" class="mt-4 block font-medium text-gray-900 hover:text-gray-700">Week</router-link>
              <router-link to="/digest/month" class="mt-4 block font-medium text-gray-900 hover:text-gray-700">Month</router-link>
            </div>
          ...
          <div class="relative bg-white">
            <div class="px-4 pt-4 pb-6">
              <router-link to="login" class="block font-medium text-gray-900 hover:text-gray-700">Log in</router-link>
            </div>
            <div class="p-4">
              <router-link to="/register" class="block px-3 py-3 font-medium text-center bg-gray-300 rounded-lg text-gray-900 hover:bg-gray-400 focus:outline-none focus:bg-gray-400">Create Account</router-link>
            </div>
          </div>
        </div>
      </transition>
